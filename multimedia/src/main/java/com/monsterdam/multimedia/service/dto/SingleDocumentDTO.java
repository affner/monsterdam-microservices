...
/**
 * A DTO for the {@link com.monsterdam.multimedia.domain.SingleDocument} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SingleDocumentDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SingleDocumentDTO)) {
            return false;
        }

        SingleDocumentDTO singleDocumentDTO = (SingleDocumentDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, singleDocumentDTO.id);
    }
