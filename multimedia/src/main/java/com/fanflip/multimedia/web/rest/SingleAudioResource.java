...
public class SingleAudioResource {
    ...
    private static final String ENTITY_NAME = "multimediaSingleAudio";
    ...
    public ResponseEntity<SingleAudioDTO> createSingleAudio(@Valid @RequestBody SingleAudioDTO singleAudioDTO) throws URISyntaxException {
        ...
        SingleAudioDTO result = singleAudioService.save(singleAudioDTO);
    ...
    public ResponseEntity<SingleAudioDTO> updateSingleAudio(
        ...
        SingleAudioDTO result = singleAudioService.update(singleAudioDTO);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, singleAudioDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SingleAudioDTO> partialUpdateSingleAudio(
        ...
        Optional<SingleAudioDTO> result = singleAudioService.partialUpdate(singleAudioDTO);

        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, singleAudioDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<SingleAudioDTO>> getAllSingleAudios(
        ...
        if ("contentpackage-is-null".equals(filter)) {
            ...
            return new ResponseEntity<>(singleAudioService.findAllWhereContentPackageIsNull(), HttpStatus.OK);
        }
