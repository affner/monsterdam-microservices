...
/**
 * A DTO for the {@link com.monsterdam.multimedia.domain.SinglePhoto} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SinglePhotoDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SinglePhotoDTO)) {
            return false;
        }

        SinglePhotoDTO singlePhotoDTO = (SinglePhotoDTO) o;
        if (this.id == null) {
            return false;
        }
