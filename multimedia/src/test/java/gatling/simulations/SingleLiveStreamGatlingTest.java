        ...
        .on(
            exec(
                http("Get all singleLiveStreams")
                    .get("/services/multimedia/api/single-live-streams")
                ...
                .exec(
                    http("Create new singleLiveStream")
                        .post("/services/multimedia/api/single-live-streams")
                        .headers(headers_http_authenticated)
                        .body(
                            StringBody(
                                "{" +
                ...
                .on(
                    exec(
                        http("Get created singleLiveStream")
                            .get("/services/multimedia${new_singleLiveStream_url}")
                            .headers(headers_http_authenticated)
                    )
                        .pause(10)
                )
                .exec(
                    http("Delete created singleLiveStream")
                        .delete("/services/multimedia${new_singleLiveStream_url}")
                        .headers(headers_http_authenticated)
                )
                .pause(10)
        );
