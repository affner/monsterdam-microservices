...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("service.com.monsterdam.app.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("security.com.monsterdam.app.DomainUserDetailsService", "createSpringSecurityUser");
