...
public class UserUIPreferencesDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserUIPreferencesDTO)) {
            return false;
        }

        UserUIPreferencesDTO userUIPreferencesDTO = (UserUIPreferencesDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, userUIPreferencesDTO.id);
    }
