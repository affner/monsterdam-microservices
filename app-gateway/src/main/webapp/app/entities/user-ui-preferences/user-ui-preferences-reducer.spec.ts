...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-ui-preferences.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERUIPREFERENCES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USERUIPREFERENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USERUIPREFERENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERUIPREFERENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERUIPREFERENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERUIPREFERENCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERUIPREFERENCES actions', async () => {
      const expectedActions = [
        {
