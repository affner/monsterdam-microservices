...
/**
 * REST controller for managing {@link com.monsterdam.profile.domain.UserSettings}.
 */
@RestController
...
public class UserSettingsResource {
    ...
    private static final String ENTITY_NAME = "profileUserSettings";
    ...
    public ResponseEntity<List<UserSettingsDTO>> getAllUserSettings(
        ...
        if ("userprofile-is-null".equals(filter)) {
            ...
            return new ResponseEntity<>(userSettingsService.findAllWhereUserProfileIsNull(), HttpStatus.OK);
        }
