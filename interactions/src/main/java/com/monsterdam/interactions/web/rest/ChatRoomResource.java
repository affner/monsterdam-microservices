...
/**
 * REST controller for managing {@link com.monsterdam.interactions.domain.ChatRoom}.
 */
@RestController
...
public class ChatRoomResource {
    ...
    private static final String ENTITY_NAME = "interactionsChatRoom";
    ...
    public ResponseEntity<ChatRoomDTO> updateChatRoom(
        ...
        ChatRoomDTO result = chatRoomService.update(chatRoomDTO);
        return ResponseEntity
            .ok()
