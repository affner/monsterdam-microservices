...
public class ChatRoom implements Serializable {
    ...
    @JoinTable(
        name = "rel_chat_room__sent_messages",
        joinColumns = @JoinColumn(name = "chat_room_id"),
        inverseJoinColumns = @JoinColumn(name = "sent_messages_id")
    )
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    ...
    public ChatRoom participantUserId(Long participantUserId) {
        this.setParticipantUserId(participantUserId);
        return this;
    }
