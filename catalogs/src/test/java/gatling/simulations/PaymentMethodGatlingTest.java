        ...
        .on(
            exec(
                http("Get all paymentMethods")
                    .get("/services/catalogs/api/payment-methods")
                ...
                .exec(
                    http("Create new paymentMethod")
                        .post("/services/catalogs/api/payment-methods")
                        .headers(headers_http_authenticated)
                        .body(
                            StringBody(
                                "{" +
                ...
                .on(
                    exec(
                        http("Get created paymentMethod")
                            .get("/services/catalogs${new_paymentMethod_url}")
                            .headers(headers_http_authenticated)
                    )
                        .pause(10)
                )
                .exec(
                    http("Delete created paymentMethod")
                        .delete("/services/catalogs${new_paymentMethod_url}")
                        .headers(headers_http_authenticated)
                )
                .pause(10)
        );
