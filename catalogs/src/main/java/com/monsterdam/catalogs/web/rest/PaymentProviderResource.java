...
import com.monsterdam.catalogs.service.PaymentProviderService;
...
/**
 * REST controller for managing {@link com.monsterdam.catalogs.domain.PaymentProvider}.
 */
@RestController
...
public class PaymentProviderResource {
    ...
    private static final String ENTITY_NAME = "catalogsPaymentProvider";
    ...
    public ResponseEntity<PaymentProviderDTO> createPaymentProvider(@Valid @RequestBody PaymentProviderDTO paymentProviderDTO)
        ...
        PaymentProviderDTO result = paymentProviderService.save(paymentProviderDTO);
    ...
    public ResponseEntity<PaymentProviderDTO> updatePaymentProvider(
        ...
        PaymentProviderDTO result = paymentProviderService.update(paymentProviderDTO);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, paymentProviderDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PaymentProviderDTO> partialUpdatePaymentProvider(
        ...
        Optional<PaymentProviderDTO> result = paymentProviderService.partialUpdate(paymentProviderDTO);

        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, paymentProviderDTO.getId().toString())
        );
    }
