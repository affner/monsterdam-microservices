...
@RestController
@RequestMapping("/api/catalogs-kafka")
public class CatalogsKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private final Logger log = LoggerFactory.getLogger(CatalogsKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public CatalogsKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
