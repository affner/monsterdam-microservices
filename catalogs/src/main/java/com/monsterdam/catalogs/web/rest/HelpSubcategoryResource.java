...
/**
 * REST controller for managing {@link com.monsterdam.catalogs.domain.HelpSubcategory}.
 */
@RestController
...
public class HelpSubcategoryResource {
    ...
    private static final String ENTITY_NAME = "catalogsHelpSubcategory";
    ...
    public ResponseEntity<HelpSubcategoryDTO> createHelpSubcategory(@Valid @RequestBody HelpSubcategoryDTO helpSubcategoryDTO)
        ...
        HelpSubcategoryDTO result = helpSubcategoryService.save(helpSubcategoryDTO);
    ...
    public ResponseEntity<HelpSubcategoryDTO> updateHelpSubcategory(
        ...
        HelpSubcategoryDTO result = helpSubcategoryService.update(helpSubcategoryDTO);
        return ResponseEntity
            .ok()
