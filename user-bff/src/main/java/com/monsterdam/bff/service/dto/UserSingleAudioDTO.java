...
public class UserSingleAudioDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UserSingleAudioDTO)) {
            return false;
        }

        UserSingleAudioDTO singleAudioDTO = (UserSingleAudioDTO) o;
        if (this.id == null) {
            return false;
        }
