...
default() {
    ...
    kubectl apply -f finance-${suffix}/
    kubectl apply -f multimedia-${suffix}/
    kubectl apply -f interactions-${suffix}/
    kubectl apply -f profile-${suffix}/
    kubectl apply -f admin-${suffix}/
