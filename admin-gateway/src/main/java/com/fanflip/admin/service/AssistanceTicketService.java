...
/**
 * Service Interface for managing {@link com.fanflip.admin.domain.AssistanceTicket}.
 */
public interface AssistanceTicketService {
     ...
     */
    Flux<AssistanceTicketDTO> findAll();
     ...
     * @return the list of entities.
     */
    Flux<AssistanceTicketDTO> search(String query);
}
