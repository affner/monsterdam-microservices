...
/**
 * Service Interface for managing {@link com.fanflip.admin.domain.ModerationAction}.
 */
public interface ModerationActionService {
     ...
     */
    Flux<ModerationActionDTO> findAll();
     ...
     * @return the list of entities.
     */
    Flux<ModerationActionDTO> search(String query);
}
