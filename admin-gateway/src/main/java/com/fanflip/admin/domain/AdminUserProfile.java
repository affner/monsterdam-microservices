...
import com.fanflip.admin.domain.enumeration.AdminGender;
...
public class AdminUserProfile implements Serializable {
    ...
    @Transient
    @JsonIgnoreProperties(value = { "moderationAction", "report", "documentsReview", "assignedAdmin" }, allowSetters = true)
