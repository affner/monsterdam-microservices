...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './admin-announcement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMINANNOUNCEMENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ADMINANNOUNCEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ADMINANNOUNCEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADMINANNOUNCEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADMINANNOUNCEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADMINANNOUNCEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADMINANNOUNCEMENT actions', async () => {
      const expectedActions = [
        {
