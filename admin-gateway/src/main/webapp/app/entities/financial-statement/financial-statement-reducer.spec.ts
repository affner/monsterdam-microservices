...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './financial-statement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINANCIALSTATEMENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FINANCIALSTATEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FINANCIALSTATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FINANCIALSTATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FINANCIALSTATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FINANCIALSTATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FINANCIALSTATEMENT actions', async () => {
      const expectedActions = [
        {
