...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './identity-document.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IDENTITYDOCUMENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_IDENTITYDOCUMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_IDENTITYDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IDENTITYDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IDENTITYDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IDENTITYDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IDENTITYDOCUMENT actions', async () => {
      const expectedActions = [
        {
