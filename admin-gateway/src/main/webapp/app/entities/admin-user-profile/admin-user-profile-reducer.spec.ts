...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './admin-user-profile.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMINUSERPROFILE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ADMINUSERPROFILES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ADMINUSERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADMINUSERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADMINUSERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADMINUSERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADMINUSERPROFILE actions', async () => {
      const expectedActions = [
        {
