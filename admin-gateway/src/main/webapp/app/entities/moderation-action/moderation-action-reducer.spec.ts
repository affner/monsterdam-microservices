...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './moderation-action.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODERATIONACTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MODERATIONACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MODERATIONACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MODERATIONACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MODERATIONACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MODERATIONACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MODERATIONACTION actions', async () => {
      const expectedActions = [
        {
