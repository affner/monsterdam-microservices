...
import com.monsterdam.admin.repository.CurrencyRepository;
import com.monsterdam.admin.service.CurrencyService;
...
/**
 * REST controller for managing {@link com.monsterdam.admin.domain.Currency}.
 */
@RestController
...
public class CurrencyResource {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<CurrencyDTO>> createCurrency(@Valid @RequestBody CurrencyDTO currencyDTO) throws URISyntaxException {
    ...
    public Mono<ResponseEntity<CurrencyDTO>> partialUpdateCurrency(
        @PathVariable(value = "id", required = false) final Long id,
        ...
        return currencyRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<CurrencyDTO> result = currencyService.partialUpdate(currencyDTO);
    ...
    public Mono<ResponseEntity<List<CurrencyDTO>>> getAllCurrencies(
        ...
        return currencyService
            .countAll()
            .zipWith(currencyService.findAll(pageable).collectList())
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<CurrencyDTO>> getCurrency(@PathVariable("id") Long id) {
        log.debug("REST request to get Currency : {}", id);
        Mono<CurrencyDTO> currencyDTO = currencyService.findOne(id);
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteCurrency(@PathVariable("id") Long id) {
     ...
     */
    @GetMapping("/_search")
    public Mono<ResponseEntity<Flux<CurrencyDTO>>> searchCurrencies(
        ...
        return currencyService
            ...
            .map(headers -> ResponseEntity.ok().headers(headers).body(currencyService.search(query, pageable)));
    }
}
