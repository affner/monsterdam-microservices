...
/**
 * REST controller for managing {@link com.monsterdam.admin.domain.AdminUserProfile}.
 */
@RestController
...
public class AdminUserProfileResource {
    ...
    public Mono<ResponseEntity<List<AdminUserProfileDTO>>> getAllAdminUserProfiles(
        @org.springdoc.core.annotations.ParameterObject Pageable pageable,
        ServerHttpRequest request
    ) {
        log.debug("REST request to get a page of AdminUserProfiles");
        return adminUserProfileService
            .countAll()
            .zipWith(adminUserProfileService.findAll(pageable).collectList())
     ...
     */
    @GetMapping("/_search")
    public Mono<ResponseEntity<Flux<AdminUserProfileDTO>>> searchAdminUserProfiles(
        @RequestParam("query") String query,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable,
        ServerHttpRequest request
    ) {
        log.debug("REST request to search for a page of AdminUserProfiles for query {}", query);
        return adminUserProfileService
            .searchCount()
            ...
            .map(headers -> ResponseEntity.ok().headers(headers).body(adminUserProfileService.search(query, pageable)));
    }
}
