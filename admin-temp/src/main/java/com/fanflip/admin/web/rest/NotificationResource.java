...
import com.monsterdam.admin.repository.NotificationRepository;
import com.monsterdam.admin.service.NotificationService;
...
/**
 * REST controller for managing {@link com.monsterdam.admin.domain.Notification}.
 */
@RestController
...
public class NotificationResource {
     ...
     */
    @GetMapping("/_search")
    public Mono<ResponseEntity<Flux<NotificationDTO>>> searchNotifications(
        ...
        return notificationService
            ...
            .map(headers -> ResponseEntity.ok().headers(headers).body(notificationService.search(query, pageable)));
    }
}
