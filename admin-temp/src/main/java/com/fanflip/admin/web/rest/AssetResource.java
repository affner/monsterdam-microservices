...
/**
 * REST controller for managing {@link com.fanflip.admin.domain.Asset}.
 */
@RestController
...
public class AssetResource {
    ...
    public Mono<ResponseEntity<List<AssetDTO>>> getAllAssets(
        ...
        return assetService
            .countAll()
            .zipWith(assetService.findAll(pageable).collectList())
     ...
     */
    @GetMapping("/_search")
    public Mono<ResponseEntity<Flux<AssetDTO>>> searchAssets(
        ...
        return assetService
            ...
            .map(headers -> ResponseEntity.ok().headers(headers).body(assetService.search(query, pageable)));
    }
}
