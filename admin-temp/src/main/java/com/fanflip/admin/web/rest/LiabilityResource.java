...
/**
 * REST controller for managing {@link com.monsterdam.admin.domain.Liability}.
 */
@RestController
...
public class LiabilityResource {
    ...
    public Mono<ResponseEntity<List<LiabilityDTO>>> getAllLiabilities(
        @org.springdoc.core.annotations.ParameterObject Pageable pageable,
        ServerHttpRequest request
    ) {
        log.debug("REST request to get a page of Liabilities");
        return liabilityService
            .countAll()
            .zipWith(liabilityService.findAll(pageable).collectList())
     ...
     */
    @GetMapping("/_search")
    public Mono<ResponseEntity<Flux<LiabilityDTO>>> searchLiabilities(
        @RequestParam("query") String query,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable,
        ServerHttpRequest request
    ) {
        log.debug("REST request to search for a page of Liabilities for query {}", query);
        return liabilityService
            .searchCount()
            ...
            .map(headers -> ResponseEntity.ok().headers(headers).body(liabilityService.search(query, pageable)));
    }
}
