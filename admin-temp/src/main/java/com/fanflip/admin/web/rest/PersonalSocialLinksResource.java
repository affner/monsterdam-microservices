...
import com.fanflip.admin.repository.PersonalSocialLinksRepository;
import com.fanflip.admin.service.PersonalSocialLinksService;
...
/**
 * REST controller for managing {@link com.fanflip.admin.domain.PersonalSocialLinks}.
 */
@RestController
...
public class PersonalSocialLinksResource {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<PersonalSocialLinksDTO>> createPersonalSocialLinks(
        ...
        return personalSocialLinksService
            .save(personalSocialLinksDTO)
            .map(result -> {
                try {
     ...
     */
    @PutMapping("/{id}")
    public Mono<ResponseEntity<PersonalSocialLinksDTO>> updatePersonalSocialLinks(
    ...
    public Mono<ResponseEntity<PersonalSocialLinksDTO>> partialUpdatePersonalSocialLinks(
        @PathVariable(value = "id", required = false) final Long id,
        ...
        return personalSocialLinksRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<PersonalSocialLinksDTO> result = personalSocialLinksService.partialUpdate(personalSocialLinksDTO);
    ...
    public Mono<ResponseEntity<List<PersonalSocialLinksDTO>>> getAllPersonalSocialLinks(
        ...
        return personalSocialLinksService
            .countAll()
            .zipWith(personalSocialLinksService.findAll(pageable).collectList())
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<PersonalSocialLinksDTO>> getPersonalSocialLinks(@PathVariable("id") Long id) {
        log.debug("REST request to get PersonalSocialLinks : {}", id);
        Mono<PersonalSocialLinksDTO> personalSocialLinksDTO = personalSocialLinksService.findOne(id);
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deletePersonalSocialLinks(@PathVariable("id") Long id) {
    ...
    /**
     * {@code SEARCH  /personal-social-links/_search?query=:query} : search for the personalSocialLinks corresponding
     * to the query.
     *
     * @param query the query of the personalSocialLinks search.
     * @param pageable the pagination information.
     * @param request a {@link ServerHttpRequest} request.
     * @return the result of the search.
     */
    @GetMapping("/_search")
    public Mono<ResponseEntity<Flux<PersonalSocialLinksDTO>>> searchPersonalSocialLinks(
        @RequestParam("query") String query,
        @org.springdoc.core.annotations.ParameterObject Pageable pageable,
        ServerHttpRequest request
    ) {
        log.debug("REST request to search for a page of PersonalSocialLinks for query {}", query);
        return personalSocialLinksService
            .searchCount()
            ...
            .map(headers -> ResponseEntity.ok().headers(headers).body(personalSocialLinksService.search(query, pageable)));
    }
}
