...
/**
 * Service Interface for managing {@link com.monsterdam.admin.domain.IdentityDocumentReview}.
 */
public interface IdentityDocumentReviewService {
     ...
     */
    Flux<IdentityDocumentReviewDTO> findAll(Pageable pageable);
     ...
     * @return the list of entities.
     */
    Flux<IdentityDocumentReviewDTO> search(String query, Pageable pageable);
}
