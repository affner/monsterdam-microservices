...
/**
 * Service Interface for managing {@link com.fanflip.admin.domain.AdminAnnouncement}.
 */
public interface AdminAnnouncementService {
     ...
     */
    Flux<AdminAnnouncementDTO> findAll(Pageable pageable);
     ...
     * @return the list of entities.
     */
    Flux<AdminAnnouncementDTO> search(String query, Pageable pageable);
}
