...
/**
 * Service Implementation for managing {@link com.fanflip.admin.domain.AdminAnnouncement}.
 */
@Service
@Transactional
public class AdminAnnouncementServiceImpl implements AdminAnnouncementService {
    ...
    public Flux<AdminAnnouncementDTO> findAll(Pageable pageable) {
        log.debug("Request to get all AdminAnnouncements");
        return adminAnnouncementRepository.findAllBy(pageable).map(adminAnnouncementMapper::toDto);
    }
    ...
    @Override
    @Transactional(readOnly = true)
    public Flux<AdminAnnouncementDTO> search(String query, Pageable pageable) {
        log.debug("Request to search for a page of AdminAnnouncements for query {}", query);
        return adminAnnouncementSearchRepository.search(query, pageable).map(adminAnnouncementMapper::toDto);
    }
}
