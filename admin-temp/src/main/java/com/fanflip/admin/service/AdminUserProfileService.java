...
/**
 * Service Interface for managing {@link com.monsterdam.admin.domain.AdminUserProfile}.
 */
public interface AdminUserProfileService {
     ...
     */
    Flux<AdminUserProfileDTO> findAll(Pageable pageable);
     ...
     * @return the list of entities.
     */
    Flux<AdminUserProfileDTO> search(String query, Pageable pageable);
}
