...
/**
 * Service Interface for managing {@link com.monsterdam.admin.domain.Budget}.
 */
public interface BudgetService {
     ...
     */
    Flux<BudgetDTO> findAll(Pageable pageable);
     ...
     * @return the list of entities.
     */
    Flux<BudgetDTO> search(String query, Pageable pageable);
}
