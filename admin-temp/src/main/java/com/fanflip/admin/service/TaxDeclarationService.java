...
/**
 * Service Interface for managing {@link com.fanflip.admin.domain.TaxDeclaration}.
 */
public interface TaxDeclarationService {
     ...
     */
    Flux<TaxDeclarationDTO> findAll(Pageable pageable);
     ...
     * @return the list of entities.
     */
    Flux<TaxDeclarationDTO> search(String query, Pageable pageable);
}
