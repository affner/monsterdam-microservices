...
/**
 * Service Interface for managing {@link com.fanflip.admin.domain.Asset}.
 */
public interface AssetService {
     ...
     */
    Flux<AssetDTO> findAll(Pageable pageable);
     ...
     * @return the list of entities.
     */
    Flux<AssetDTO> search(String query, Pageable pageable);
}
