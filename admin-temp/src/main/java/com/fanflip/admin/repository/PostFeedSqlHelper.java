...
public class PostFeedSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(Column.aliased("id", table, columnPrefix + "_id"));
        columns.add(Column.aliased("post_content", table, columnPrefix + "_post_content"));
        columns.add(Column.aliased("is_hidden", table, columnPrefix + "_is_hidden"));
        columns.add(Column.aliased("pinned_post", table, columnPrefix + "_pinned_post"));
