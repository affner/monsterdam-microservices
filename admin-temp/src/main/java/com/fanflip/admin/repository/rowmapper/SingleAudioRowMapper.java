...
/**
 * Converter between {@link Row} to {@link SingleAudio}, with proper type conversions.
 */
@Service
public class SingleAudioRowMapper implements BiFunction<Row, String, SingleAudio> {

    private final ColumnConverter converter;

    public SingleAudioRowMapper(ColumnConverter converter) {
        this.converter = converter;
    }

    /**
     * Take a {@link Row} and a column prefix, and extract all the fields.
     * @return the {@link SingleAudio} stored in the database.
     */
    @Override
    public SingleAudio apply(Row row, String prefix) {
        SingleAudio entity = new SingleAudio();
