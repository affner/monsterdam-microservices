...
/**
 * Converter between {@link Row} to {@link SingleVideo}, with proper type conversions.
 */
@Service
public class SingleVideoRowMapper implements BiFunction<Row, String, SingleVideo> {

    private final ColumnConverter converter;

    public SingleVideoRowMapper(ColumnConverter converter) {
        this.converter = converter;
    }

    /**
     * Take a {@link Row} and a column prefix, and extract all the fields.
     * @return the {@link SingleVideo} stored in the database.
     */
    @Override
    public SingleVideo apply(Row row, String prefix) {
        SingleVideo entity = new SingleVideo();
        ...
        entity.setBelongPackageId(converter.fromRow(row, prefix + "_belong_package_id", Long.class));
        return entity;
    }
}
