...
public class LikeMarkSqlHelper {

    public static List<Expression> getColumns(Table table, String columnPrefix) {
        List<Expression> columns = new ArrayList<>();
        columns.add(Column.aliased("id", table, columnPrefix + "_id"));
        columns.add(Column.aliased("emoji_type_id", table, columnPrefix + "_emoji_type_id"));
        ...
        columns.add(Column.aliased("multimedia_id", table, columnPrefix + "_multimedia_id"));
        ...
        columns.add(Column.aliased("liker_user_id", table, columnPrefix + "_liker_user_id"));
