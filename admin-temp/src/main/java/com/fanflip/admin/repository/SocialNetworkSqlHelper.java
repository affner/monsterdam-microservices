...
public class SocialNetworkSqlHelper {
    ...
    public static List<Expression> getColumns(Table table, String columnPrefix) {
        ...
        columns.add(Column.aliased("complete_name", table, columnPrefix + "_complete_name"));
        columns.add(Column.aliased("main_link", table, columnPrefix + "_main_link"));
