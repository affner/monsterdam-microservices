...
/**
 * Converter between {@link Row} to {@link SinglePhoto}, with proper type conversions.
 */
@Service
public class SinglePhotoRowMapper implements BiFunction<Row, String, SinglePhoto> {

    private final ColumnConverter converter;

    public SinglePhotoRowMapper(ColumnConverter converter) {
        this.converter = converter;
    }

    /**
     * Take a {@link Row} and a column prefix, and extract all the fields.
     * @return the {@link SinglePhoto} stored in the database.
     */
    @Override
    public SinglePhoto apply(Row row, String prefix) {
        SinglePhoto entity = new SinglePhoto();
