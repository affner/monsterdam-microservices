...
export const AdminAnnouncement = () => {
  ...
  const totalItems = useAppSelector(state => state.admin.adminAnnouncement.totalItems);
            ...
            <tbody>
              {adminAnnouncementList.map((adminAnnouncement, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {adminAnnouncement.announcerMessage ? (
                      <Link to={`/direct-message/${adminAnnouncement.announcerMessage.id}`}>{adminAnnouncement.announcerMessage.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
