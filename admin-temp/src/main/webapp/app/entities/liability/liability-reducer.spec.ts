...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIABILITY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LIABILITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LIABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIABILITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIABILITY actions', async () => {
      const expectedActions = [
        {
