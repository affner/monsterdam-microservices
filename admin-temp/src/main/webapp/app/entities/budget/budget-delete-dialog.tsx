...
export const BudgetDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/budget' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adminApp.budget.delete.question">
        <Translate contentKey="adminApp.budget.delete.question" interpolate={{ id: budgetEntity.id }}>
