...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIKEMARK_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LIKEMARKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LIKEMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIKEMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIKEMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIKEMARK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIKEMARK actions', async () => {
      const expectedActions = [
        {
