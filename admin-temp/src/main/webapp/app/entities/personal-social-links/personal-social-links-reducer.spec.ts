...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './personal-social-links.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERSONALSOCIALLINKS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PERSONALSOCIALLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PERSONALSOCIALLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERSONALSOCIALLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERSONALSOCIALLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERSONALSOCIALLINKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERSONALSOCIALLINKS actions', async () => {
      const expectedActions = [
        {
