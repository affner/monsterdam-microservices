...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POLLOPTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_POLLOPTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_POLLOPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POLLOPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POLLOPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POLLOPTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POLLOPTION actions', async () => {
      const expectedActions = [
        {
