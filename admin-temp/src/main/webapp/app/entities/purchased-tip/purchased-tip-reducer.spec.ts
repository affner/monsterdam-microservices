...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PURCHASEDTIP_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PURCHASEDTIPS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PURCHASEDTIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PURCHASEDTIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PURCHASEDTIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PURCHASEDTIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PURCHASEDTIP actions', async () => {
      const expectedActions = [
        {
