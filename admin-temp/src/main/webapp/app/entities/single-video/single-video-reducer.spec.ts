...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SINGLEVIDEO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SINGLEVIDEOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SINGLEVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SINGLEVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SINGLEVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SINGLEVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SINGLEVIDEO actions', async () => {
      const expectedActions = [
        {
