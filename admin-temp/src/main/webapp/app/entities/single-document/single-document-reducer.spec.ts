...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SINGLEDOCUMENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SINGLEDOCUMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SINGLEDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SINGLEDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SINGLEDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SINGLEDOCUMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SINGLEDOCUMENT actions', async () => {
      const expectedActions = [
        {
