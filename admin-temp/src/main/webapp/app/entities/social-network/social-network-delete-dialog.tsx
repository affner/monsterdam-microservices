...
import { getEntity, deleteEntity } from './social-network.reducer';

export const SocialNetworkDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.admin.socialNetwork.updateSuccess);

  const handleClose = () => {
    navigate('/social-network' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adminApp.socialNetwork.delete.question">
        <Translate contentKey="adminApp.socialNetwork.delete.question" interpolate={{ id: socialNetworkEntity.id }}>
