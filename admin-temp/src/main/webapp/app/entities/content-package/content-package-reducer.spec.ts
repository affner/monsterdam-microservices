...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTENTPACKAGE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CONTENTPACKAGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CONTENTPACKAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTENTPACKAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTENTPACKAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTENTPACKAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTENTPACKAGE actions', async () => {
      const expectedActions = [
        {
