...
import { searchEntities, getEntities } from './content-package.reducer';
...
export const ContentPackage = () => {
  ...
  const contentPackageList = useAppSelector(state => state.admin.contentPackage.entities);
  const loading = useAppSelector(state => state.admin.contentPackage.loading);
  const totalItems = useAppSelector(state => state.admin.contentPackage.totalItems);
  ...
  return (
    <div>
      <h2 id="content-package-heading" data-cy="ContentPackageHeading">
        <Translate contentKey="adminApp.contentPackage.home.title">Content Packages</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adminApp.contentPackage.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/content-package/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="adminApp.contentPackage.home.createLabel">Create new Content Package</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('adminApp.contentPackage.home.search')}
                />
        ...
        {contentPackageList && contentPackageList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="adminApp.contentPackage.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="adminApp.contentPackage.audio">Audio</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {contentPackageList.map((contentPackage, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{contentPackage.isDeleted ? 'true' : 'false'}</td>
                  <td>
                    {contentPackage.audio ? <Link to={`/single-audio/${contentPackage.audio.id}`}>{contentPackage.audio.id}</Link> : ''}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adminApp.contentPackage.home.notFound">No Content Packages found</Translate>
            </div>
          )
        )}
      </div>
