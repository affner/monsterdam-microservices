...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERMENTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USERMENTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USERMENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERMENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERMENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERMENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERMENTION actions', async () => {
      const expectedActions = [
        {
