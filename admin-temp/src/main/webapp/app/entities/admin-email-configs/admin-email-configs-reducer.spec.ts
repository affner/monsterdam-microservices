...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './admin-email-configs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMINEMAILCONFIGS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ADMINEMAILCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ADMINEMAILCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADMINEMAILCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADMINEMAILCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADMINEMAILCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADMINEMAILCONFIGS actions', async () => {
      const expectedActions = [
        {
