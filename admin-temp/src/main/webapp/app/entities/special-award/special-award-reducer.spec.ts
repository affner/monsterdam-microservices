...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALAWARD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SPECIALAWARDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SPECIALAWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPECIALAWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPECIALAWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALAWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPECIALAWARD actions', async () => {
      const expectedActions = [
        {
