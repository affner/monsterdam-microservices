...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POLLVOTE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_POLLVOTES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_POLLVOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POLLVOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POLLVOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POLLVOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POLLVOTE actions', async () => {
      const expectedActions = [
        {
