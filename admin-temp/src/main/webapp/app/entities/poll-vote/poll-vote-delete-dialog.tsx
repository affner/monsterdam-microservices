...
import { getEntity, deleteEntity } from './poll-vote.reducer';
...
export const PollVoteDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adminApp.pollVote.delete.question">
        <Translate contentKey="adminApp.pollVote.delete.question" interpolate={{ id: pollVoteEntity.id }}>
