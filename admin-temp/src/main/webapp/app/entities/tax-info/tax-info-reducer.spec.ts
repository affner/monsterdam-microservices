...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAXINFO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TAXINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TAXINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAXINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAXINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAXINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAXINFO actions', async () => {
      const expectedActions = [
        {
