...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './accounting-record.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCOUNTINGRECORD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ACCOUNTINGRECORDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ACCOUNTINGRECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ACCOUNTINGRECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ACCOUNTINGRECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ACCOUNTINGRECORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ACCOUNTINGRECORD actions', async () => {
      const expectedActions = [
        {
