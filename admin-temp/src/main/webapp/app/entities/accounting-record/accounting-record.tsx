...
export const AccountingRecord = () => {
  ...
  const totalItems = useAppSelector(state => state.admin.accountingRecord.totalItems);
  ...
  return (
    <div>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="adminApp.accountingRecord.payment">Payment</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {accountingRecordList.map((accountingRecord, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {accountingRecord.payment ? (
                      <Link to={`/payment-transaction/${accountingRecord.payment.id}`}>{accountingRecord.payment.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/accounting-record/${accountingRecord.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/accounting-record/${accountingRecord.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
      ...
      {totalItems ? (
        <div className={accountingRecordList && accountingRecordList.length > 0 ? '' : 'd-none'}>
