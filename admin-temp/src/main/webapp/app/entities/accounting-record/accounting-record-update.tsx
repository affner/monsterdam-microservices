...
export const AccountingRecordUpdate = () => {
  ...
  const handleClose = () => {
    navigate('/accounting-record' + location.search);
  };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          payment: accountingRecordEntity?.payment?.id,
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                id="accounting-record-payment"
                name="payment"
                data-cy="payment"
                label={translate('adminApp.accountingRecord.payment')}
                type="select"
              >
                <option value="" key="0" />
                {paymentTransactions
