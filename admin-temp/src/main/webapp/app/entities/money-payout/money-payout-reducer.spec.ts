...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MONEYPAYOUT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MONEYPAYOUTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MONEYPAYOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MONEYPAYOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MONEYPAYOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MONEYPAYOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MONEYPAYOUT actions', async () => {
      const expectedActions = [
        {
