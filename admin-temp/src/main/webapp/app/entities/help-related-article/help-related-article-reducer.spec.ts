...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './help-related-article.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HELPRELATEDARTICLE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_HELPRELATEDARTICLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_HELPRELATEDARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HELPRELATEDARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HELPRELATEDARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HELPRELATEDARTICLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HELPRELATEDARTICLE actions', async () => {
      const expectedActions = [
        {
