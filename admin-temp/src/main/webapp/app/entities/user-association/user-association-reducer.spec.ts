...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERASSOCIATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USERASSOCIATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USERASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERASSOCIATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERASSOCIATION actions', async () => {
      const expectedActions = [
        {
