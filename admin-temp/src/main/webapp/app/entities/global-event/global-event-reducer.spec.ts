...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GLOBALEVENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_GLOBALEVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_GLOBALEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GLOBALEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GLOBALEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GLOBALEVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GLOBALEVENT actions', async () => {
      const expectedActions = [
        {
