...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HELPQUESTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_HELPQUESTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_HELPQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HELPQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HELPQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HELPQUESTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HELPQUESTION actions', async () => {
      const expectedActions = [
        {
