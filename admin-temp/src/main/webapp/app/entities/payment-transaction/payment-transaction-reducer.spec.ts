...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './payment-transaction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYMENTTRANSACTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAYMENTTRANSACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAYMENTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYMENTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYMENTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYMENTTRANSACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYMENTTRANSACTION actions', async () => {
      const expectedActions = [
        {
