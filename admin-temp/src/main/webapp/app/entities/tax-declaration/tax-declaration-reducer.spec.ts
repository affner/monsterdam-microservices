...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAXDECLARATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TAXDECLARATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TAXDECLARATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAXDECLARATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAXDECLARATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAXDECLARATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAXDECLARATION actions', async () => {
      const expectedActions = [
        {
