...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOSTORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_VIDEOSTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_VIDEOSTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VIDEOSTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VIDEOSTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOSTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VIDEOSTORY actions', async () => {
      const expectedActions = [
        {
