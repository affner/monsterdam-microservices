...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALREWARD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SPECIALREWARDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SPECIALREWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPECIALREWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPECIALREWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALREWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPECIALREWARD actions', async () => {
      const expectedActions = [
        {
