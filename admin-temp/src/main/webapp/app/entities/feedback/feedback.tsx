...
import { searchEntities, getEntities } from './feedback.reducer';
...
export const Feedback = () => {
  ...
  const feedbackList = useAppSelector(state => state.admin.feedback.entities);
  const loading = useAppSelector(state => state.admin.feedback.loading);
  const totalItems = useAppSelector(state => state.admin.feedback.totalItems);
  ...
  return (
    <div>
      <h2 id="feedback-heading" data-cy="FeedbackHeading">
        <Translate contentKey="adminApp.feedback.home.title">Feedbacks</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adminApp.feedback.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/feedback/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="adminApp.feedback.home.createLabel">Create new Feedback</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('adminApp.feedback.home.search')}
                />
        ...
        {feedbackList && feedbackList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="adminApp.feedback.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="adminApp.feedback.creator">Creator</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {feedbackList.map((feedback, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`adminApp.FeedbackType.${feedback.feedbackType}`} />
                  </td>
                  ...
                  <td>{feedback.isDeleted ? 'true' : 'false'}</td>
                  <td>{feedback.creator ? <Link to={`/user-profile/${feedback.creator.id}`}>{feedback.creator.id}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adminApp.feedback.home.notFound">No Feedbacks found</Translate>
            </div>
          )
        )}
      </div>
