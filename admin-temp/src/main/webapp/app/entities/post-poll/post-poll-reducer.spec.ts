...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTPOLL_LIST actions', async () => {
    ...
    it('dispatches SEARCH_POSTPOLLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_POSTPOLL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTPOLL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTPOLL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTPOLL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTPOLL actions', async () => {
      const expectedActions = [
        {
