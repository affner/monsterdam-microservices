...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAYOUTMETHOD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PAYOUTMETHODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PAYOUTMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAYOUTMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAYOUTMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAYOUTMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAYOUTMETHOD actions', async () => {
      const expectedActions = [
        {
