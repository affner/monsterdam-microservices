...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HELPCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_HELPCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_HELPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HELPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HELPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HELPCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HELPCATEGORY actions', async () => {
      const expectedActions = [
        {
