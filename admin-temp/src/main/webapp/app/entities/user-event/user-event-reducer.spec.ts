...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USEREVENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USEREVENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USEREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USEREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USEREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USEREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USEREVENT actions', async () => {
      const expectedActions = [
        {
