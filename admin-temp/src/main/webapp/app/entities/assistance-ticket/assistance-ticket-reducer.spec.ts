...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './assistance-ticket.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSISTANCETICKET_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ASSISTANCETICKETS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ASSISTANCETICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSISTANCETICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSISTANCETICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSISTANCETICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSISTANCETICKET actions', async () => {
      const expectedActions = [
        {
