...
export const CountryDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.admin.country.updateSuccess);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adminApp.country.delete.question">
        <Translate contentKey="adminApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
