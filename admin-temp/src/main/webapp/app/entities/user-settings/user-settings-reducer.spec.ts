...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERSETTINGS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USERSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USERSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERSETTINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERSETTINGS actions', async () => {
      const expectedActions = [
        {
