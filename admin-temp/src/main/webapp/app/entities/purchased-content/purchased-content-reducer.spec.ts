...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './purchased-content.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PURCHASEDCONTENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PURCHASEDCONTENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PURCHASEDCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PURCHASEDCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PURCHASEDCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PURCHASEDCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PURCHASEDCONTENT actions', async () => {
      const expectedActions = [
        {
