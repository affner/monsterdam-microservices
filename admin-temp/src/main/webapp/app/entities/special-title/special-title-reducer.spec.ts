...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALTITLE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SPECIALTITLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SPECIALTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPECIALTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPECIALTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALTITLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPECIALTITLE actions', async () => {
      const expectedActions = [
        {
