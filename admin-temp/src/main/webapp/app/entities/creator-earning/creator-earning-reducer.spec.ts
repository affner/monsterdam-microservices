...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CREATOREARNING_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CREATOREARNINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CREATOREARNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CREATOREARNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CREATOREARNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CREATOREARNING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CREATOREARNING actions', async () => {
      const expectedActions = [
        {
