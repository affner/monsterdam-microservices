...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HELPSUBCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_HELPSUBCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_HELPSUBCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HELPSUBCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HELPSUBCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HELPSUBCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HELPSUBCATEGORY actions', async () => {
      const expectedActions = [
        {
