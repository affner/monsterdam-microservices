...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTFEED_LIST actions', async () => {
    ...
    it('dispatches SEARCH_POSTFEEDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_POSTFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POSTFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POSTFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POSTFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POSTFEED actions', async () => {
      const expectedActions = [
        {
