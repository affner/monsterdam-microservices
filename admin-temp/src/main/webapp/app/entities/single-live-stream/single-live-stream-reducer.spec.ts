...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './single-live-stream.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SINGLELIVESTREAM_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SINGLELIVESTREAMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SINGLELIVESTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SINGLELIVESTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SINGLELIVESTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SINGLELIVESTREAM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SINGLELIVESTREAM actions', async () => {
      const expectedActions = [
        {
