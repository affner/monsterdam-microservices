...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './document-review-observation.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTREVIEWOBSERVATION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DOCUMENTREVIEWOBSERVATIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DOCUMENTREVIEWOBSERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCUMENTREVIEWOBSERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCUMENTREVIEWOBSERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTREVIEWOBSERVATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCUMENTREVIEWOBSERVATION actions', async () => {
      const expectedActions = [
        {
