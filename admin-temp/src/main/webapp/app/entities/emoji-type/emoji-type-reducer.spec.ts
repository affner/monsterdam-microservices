...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMOJITYPE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_EMOJITYPES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_EMOJITYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMOJITYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMOJITYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMOJITYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMOJITYPE actions', async () => {
      const expectedActions = [
        {
