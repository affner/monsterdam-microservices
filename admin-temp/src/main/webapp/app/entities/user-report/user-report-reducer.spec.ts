...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERREPORT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USERREPORTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USERREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERREPORT actions', async () => {
      const expectedActions = [
        {
