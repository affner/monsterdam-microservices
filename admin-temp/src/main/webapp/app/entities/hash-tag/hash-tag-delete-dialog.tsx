...
export const HashTagDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/hash-tag' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adminApp.hashTag.delete.question">
        <Translate contentKey="adminApp.hashTag.delete.question" interpolate={{ id: hashTagEntity.id }}>
