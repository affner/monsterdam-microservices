...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OFFERPROMOTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_OFFERPROMOTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_OFFERPROMOTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OFFERPROMOTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OFFERPROMOTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OFFERPROMOTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OFFERPROMOTION actions', async () => {
      const expectedActions = [
        {
