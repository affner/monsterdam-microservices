...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SINGLEPHOTO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SINGLEPHOTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SINGLEPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SINGLEPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SINGLEPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SINGLEPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SINGLEPHOTO actions', async () => {
      const expectedActions = [
        {
