...
export const PaymentProviderDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/payment-provider' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adminApp.paymentProvider.delete.question">
        <Translate contentKey="adminApp.paymentProvider.delete.question" interpolate={{ id: paymentProviderEntity.id }}>
