...
import { searchEntities, getEntities } from './payment-provider.reducer';
...
export const PaymentProvider = () => {
  ...
  const paymentProviderList = useAppSelector(state => state.admin.paymentProvider.entities);
  const loading = useAppSelector(state => state.admin.paymentProvider.loading);
  const totalItems = useAppSelector(state => state.admin.paymentProvider.totalItems);
  ...
  return (
    <div>
      <h2 id="payment-provider-heading" data-cy="PaymentProviderHeading">
        <Translate contentKey="adminApp.paymentProvider.home.title">Payment Providers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adminApp.paymentProvider.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/payment-provider/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="adminApp.paymentProvider.home.createLabel">Create new Payment Provider</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('adminApp.paymentProvider.home.search')}
                />
        ...
        {paymentProviderList && paymentProviderList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="adminApp.paymentProvider.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adminApp.paymentProvider.home.notFound">No Payment Providers found</Translate>
            </div>
          )
        )}
      </div>
