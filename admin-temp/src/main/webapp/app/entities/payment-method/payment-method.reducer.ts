...
const apiSearchUrl = 'api/payment-methods/_search';

// Actions

export const searchEntities = createAsyncThunk('paymentMethod/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
