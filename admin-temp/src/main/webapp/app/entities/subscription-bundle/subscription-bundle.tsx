...
import { searchEntities, getEntities } from './subscription-bundle.reducer';
...
export const SubscriptionBundle = () => {
  ...
  const subscriptionBundleList = useAppSelector(state => state.admin.subscriptionBundle.entities);
  const loading = useAppSelector(state => state.admin.subscriptionBundle.loading);
  const totalItems = useAppSelector(state => state.admin.subscriptionBundle.totalItems);
  ...
  return (
    <div>
      <h2 id="subscription-bundle-heading" data-cy="SubscriptionBundleHeading">
        <Translate contentKey="adminApp.subscriptionBundle.home.title">Subscription Bundles</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="adminApp.subscriptionBundle.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="adminApp.subscriptionBundle.home.createLabel">Create new Subscription Bundle</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('adminApp.subscriptionBundle.home.search')}
                />
        ...
        {subscriptionBundleList && subscriptionBundleList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="adminApp.subscriptionBundle.id">ID</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="adminApp.subscriptionBundle.creator">Creator</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {subscriptionBundle.creator ? (
                      <Link to={`/user-profile/${subscriptionBundle.creator.id}`}>{subscriptionBundle.creator.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="adminApp.subscriptionBundle.home.notFound">No Subscription Bundles found</Translate>
            </div>
          )
        )}
      </div>
