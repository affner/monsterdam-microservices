...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './subscription-bundle.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBSCRIPTIONBUNDLE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SUBSCRIPTIONBUNDLES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SUBSCRIPTIONBUNDLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUBSCRIPTIONBUNDLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUBSCRIPTIONBUNDLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUBSCRIPTIONBUNDLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUBSCRIPTIONBUNDLE actions', async () => {
      const expectedActions = [
        {
