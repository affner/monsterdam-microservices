...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SINGLEAUDIO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SINGLEAUDIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SINGLEAUDIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SINGLEAUDIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SINGLEAUDIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SINGLEAUDIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SINGLEAUDIO actions', async () => {
      const expectedActions = [
        {
