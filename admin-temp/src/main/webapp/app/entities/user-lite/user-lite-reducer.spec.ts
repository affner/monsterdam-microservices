...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERLITE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USERLITES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USERLITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERLITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERLITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERLITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERLITE actions', async () => {
      const expectedActions = [
        {
