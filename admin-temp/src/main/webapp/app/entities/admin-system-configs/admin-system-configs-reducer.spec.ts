...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './admin-system-configs.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMINSYSTEMCONFIGS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ADMINSYSTEMCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ADMINSYSTEMCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADMINSYSTEMCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADMINSYSTEMCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADMINSYSTEMCONFIGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADMINSYSTEMCONFIGS actions', async () => {
      const expectedActions = [
        {
