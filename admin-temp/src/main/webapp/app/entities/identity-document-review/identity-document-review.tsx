...
export const IdentityDocumentReview = () => {
  ...
  const totalItems = useAppSelector(state => state.admin.identityDocumentReview.totalItems);
  ...
  return (
    <div>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/identity-document-review/${identityDocumentReview.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      ...
                      <Button
                        onClick={() =>
                          (window.location.href = `/identity-document-review/${identityDocumentReview.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`)
                        }
                        color="danger"
                        size="sm"
      ...
      {totalItems ? (
        <div className={identityDocumentReviewList && identityDocumentReviewList.length > 0 ? '' : 'd-none'}>
