...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './identity-document-review.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IDENTITYDOCUMENTREVIEW_LIST actions', async () => {
    ...
    it('dispatches SEARCH_IDENTITYDOCUMENTREVIEWS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_IDENTITYDOCUMENTREVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_IDENTITYDOCUMENTREVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_IDENTITYDOCUMENTREVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_IDENTITYDOCUMENTREVIEW actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_IDENTITYDOCUMENTREVIEW actions', async () => {
      const expectedActions = [
        {
