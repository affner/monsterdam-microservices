...
const apiSearchUrl = 'api/direct-messages/_search';

// Actions

export const searchEntities = createAsyncThunk('directMessage/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IDirectMessage, thunkAPI) => {
    return axios.post<IDirectMessage>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IDirectMessage, thunkAPI) => {
    return axios.put<IDirectMessage>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IDirectMessage, thunkAPI) => {
    return axios.patch<IDirectMessage>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError },
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<IDirectMessage>(requestUrl);
  },
  { serializeError: serializeAxiosError },
);
