...
describe('Liability e2e test', () => {
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/api/liabilities?page=0&size=20>; rel="last",<http://localhost/api/liabilities?page=0&size=20>; rel="first"',
              },
              body: [liability],
            },
  ...
  describe('new Liability page', () => {
    ...
    it('should create an instance of Liability', () => {
      ...
      cy.get(`[data-cy="dueDate"]`).type('2024-02-29');
      cy.get(`[data-cy="dueDate"]`).blur();
      cy.get(`[data-cy="dueDate"]`).should('have.value', '2024-02-29');
