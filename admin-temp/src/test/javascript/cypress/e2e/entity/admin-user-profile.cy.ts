...
describe('AdminUserProfile e2e test', () => {
  ...
  const adminUserProfileSample = {
    ...
    nickName: 'yg1fctr',
    gender: 'TRANS_FEMALE',
    lastLoginDate: '2024-02-29T02:28:45.890Z',
    birthDate: '2024-02-28',
    createdDate: '2024-02-29T17:47:28.265Z',
    isDeleted: true,
  };
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/api/admin-user-profiles?page=0&size=20>; rel="last",<http://localhost/api/admin-user-profiles?page=0&size=20>; rel="first"',
              },
  ...
  describe('new AdminUserProfile page', () => {
    ...
    it('should create an instance of AdminUserProfile', () => {
      ...
      cy.get(`[data-cy="lastLoginDate"]`).type('2024-02-29T21:59');
      cy.get(`[data-cy="lastLoginDate"]`).blur();
      cy.get(`[data-cy="lastLoginDate"]`).should('have.value', '2024-02-29T21:59');
      ...
      cy.get(`[data-cy="createdDate"]`).type('2024-02-29T22:11');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2024-02-29T22:11');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2024-02-29T05:18');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2024-02-29T05:18');
