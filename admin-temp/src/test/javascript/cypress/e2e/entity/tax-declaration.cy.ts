...
describe('TaxDeclaration e2e test', () => {
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/api/tax-declarations?page=0&size=20>; rel="last",<http://localhost/api/tax-declarations?page=0&size=20>; rel="first"',
              },
              body: [taxDeclaration],
            },
  ...
  describe('new TaxDeclaration page', () => {
    ...
    it('should create an instance of TaxDeclaration', () => {
      ...
      cy.get(`[data-cy="submittedDate"]`).type('2024-02-29T23:07');
      cy.get(`[data-cy="submittedDate"]`).blur();
      cy.get(`[data-cy="submittedDate"]`).should('have.value', '2024-02-29T23:07');
