...
describe('FinancialStatement e2e test', () => {
  ...
  const financialStatementSample = {
    ...
    periodStartDate: '2024-02-29',
    periodEndDate: '2024-02-29',
    createdDate: '2024-02-29T13:50:15.432Z',
  };
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/api/financial-statements?page=0&size=20>; rel="last",<http://localhost/api/financial-statements?page=0&size=20>; rel="first"',
              },
  ...
  describe('new FinancialStatement page', () => {
    ...
    it('should create an instance of FinancialStatement', () => {
      ...
      cy.get(`[data-cy="periodStartDate"]`).type('2024-02-29');
      cy.get(`[data-cy="periodStartDate"]`).blur();
      cy.get(`[data-cy="periodStartDate"]`).should('have.value', '2024-02-29');

      cy.get(`[data-cy="periodEndDate"]`).type('2024-02-29');
      cy.get(`[data-cy="periodEndDate"]`).blur();
      cy.get(`[data-cy="periodEndDate"]`).should('have.value', '2024-02-29');

      cy.get(`[data-cy="createdDate"]`).type('2024-02-29T19:58');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2024-02-29T19:58');
