...
describe('IdentityDocumentReview e2e test', () => {
  ...
  const identityDocumentReviewSample = { createdDate: '2024-02-29T10:29:15.099Z' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        subject: 'between before',
        description: 'printer over',
        status: 'ASSIGNED',
        type: 'OTHER',
        openedAt: '2024-02-29T08:01:42.411Z',
        closedAt: '2024-02-29T22:58:57.564Z',
        comments: 'tarnish aw apropos',
        createdDate: '2024-02-29T08:16:28.104Z',
        lastModifiedDate: '2024-02-29T10:57:57.566Z',
        createdBy: 'inside anenst',
        lastModifiedBy: 'whoa brilliant warble',
      },
    }).then(({ body }) => {
  ...
  describe('new IdentityDocumentReview page', () => {
    ...
    it('should create an instance of IdentityDocumentReview', () => {
      ...
      cy.get(`[data-cy="resolutionDate"]`).type('2024-02-29T17:57');
      cy.get(`[data-cy="resolutionDate"]`).blur();
      cy.get(`[data-cy="resolutionDate"]`).should('have.value', '2024-02-29T17:57');

      cy.get(`[data-cy="reviewStatus"]`).select('REJECTED');

      cy.get(`[data-cy="createdDate"]`).type('2024-02-29T04:08');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2024-02-29T04:08');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2024-02-29T00:47');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2024-02-29T00:47');
