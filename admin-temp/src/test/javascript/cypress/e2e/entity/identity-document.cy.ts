...
describe('IdentityDocument e2e test', () => {
  ...
  const identityDocumentSample = {
    ...
    createdDate: '2024-02-29T03:39:17.587Z',
  };
  ...
  describe('new IdentityDocument page', () => {
    ...
    it('should create an instance of IdentityDocument', () => {
      ...
      cy.get(`[data-cy="createdDate"]`).type('2024-02-29T22:13');
      cy.get(`[data-cy="createdDate"]`).blur();
      cy.get(`[data-cy="createdDate"]`).should('have.value', '2024-02-29T22:13');

      cy.get(`[data-cy="lastModifiedDate"]`).type('2024-02-29T14:05');
      cy.get(`[data-cy="lastModifiedDate"]`).blur();
      cy.get(`[data-cy="lastModifiedDate"]`).should('have.value', '2024-02-29T14:05');
