...
public class SubscriptionBundleTestSamples {
    ...
    public static SubscriptionBundle getSubscriptionBundleSample1() {
        return new SubscriptionBundle().id(1L).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static SubscriptionBundle getSubscriptionBundleSample2() {
        return new SubscriptionBundle().id(2L).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
