...
public class UserAssociationTestSamples {
    ...
    public static UserAssociation getUserAssociationSample1() {
        return new UserAssociation().id(1L).associationToken("associationToken1").createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static UserAssociation getUserAssociationSample2() {
        return new UserAssociation().id(2L).associationToken("associationToken2").createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
