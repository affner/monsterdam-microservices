...
class PurchasedTipTest {
    ...
    void messageTest() throws Exception {
        ...
        purchasedTip.setMessage(directMessageBack);
        assertThat(purchasedTip.getMessage()).isEqualTo(directMessageBack);

        purchasedTip.message(null);
        assertThat(purchasedTip.getMessage()).isNull();
    }
}
