...
public class ContentPackageTestSamples {
    ...
    public static ContentPackage getContentPackageSample1() {
        return new ContentPackage().id(1L).videoCount(1).imageCount(1).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static ContentPackage getContentPackageSample2() {
        return new ContentPackage().id(2L).videoCount(2).imageCount(2).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
