...
public class PaymentTransactionTestSamples {
    ...
    public static PaymentTransaction getPaymentTransactionSample1() {
        return new PaymentTransaction().id(1L).paymentReference("paymentReference1").cloudTransactionId("cloudTransactionId1");
    }

    public static PaymentTransaction getPaymentTransactionSample2() {
        return new PaymentTransaction().id(2L).paymentReference("paymentReference2").cloudTransactionId("cloudTransactionId2");
    }
