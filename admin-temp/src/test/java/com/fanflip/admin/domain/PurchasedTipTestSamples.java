...
public class PurchasedTipTestSamples {
    ...
    public static PurchasedTip getPurchasedTipSample1() {
        return new PurchasedTip().id(1L).createdBy("createdBy1").lastModifiedBy("lastModifiedBy1");
    }

    public static PurchasedTip getPurchasedTipSample2() {
        return new PurchasedTip().id(2L).createdBy("createdBy2").lastModifiedBy("lastModifiedBy2");
    }
