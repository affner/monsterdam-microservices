package com.fanflip.admin.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.fanflip.admin.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.fanflip.admin.security.DomainUserDetailsService", "createSpringSecurityUser");
