...
import com.monsterdam.finance.broker.KafkaConsumer;
...
@RestController
@RequestMapping("/api/finance-kafka")
@ConditionalOnProperty(prefix = "app.features", name = "kafka-enabled", havingValue = "true")
public class FinanceKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private final Logger log = LoggerFactory.getLogger(FinanceKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public FinanceKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
