...
import com.fanflip.finance.service.PaymentTransactionService;
...
/**
 * REST controller for managing {@link com.fanflip.finance.domain.PaymentTransaction}.
 */
@RestController
...
public class PaymentTransactionResource {
    ...
    private static final String ENTITY_NAME = "financePaymentTransaction";
    ...
    public ResponseEntity<PaymentTransactionDTO> updatePaymentTransaction(
        ...
        PaymentTransactionDTO result = paymentTransactionService.update(paymentTransactionDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<PaymentTransactionDTO>> getAllPaymentTransactions(
        ...
        if ("wallettransaction-is-null".equals(filter)) {
            ...
            return new ResponseEntity<>(paymentTransactionService.findAllWhereWalletTransactionIsNull(), HttpStatus.OK);
        }

        if ("purchasedtip-is-null".equals(filter)) {
            log.debug("REST request to get all PaymentTransactions where purchasedTip is null");
            return new ResponseEntity<>(paymentTransactionService.findAllWherePurchasedTipIsNull(), HttpStatus.OK);
        }
        ...
        if ("purchasedcontent-is-null".equals(filter)) {
            ...
            return new ResponseEntity<>(paymentTransactionService.findAllWherePurchasedContentIsNull(), HttpStatus.OK);
        }
        ...
        if ("purchasedsubscription-is-null".equals(filter)) {
            ...
            return new ResponseEntity<>(paymentTransactionService.findAllWherePurchasedSubscriptionIsNull(), HttpStatus.OK);
        }
